...
public class ProfileDocumentTest
{
	...
	public void LoadProfileTest1()
	{
		...
		Assert.IsTrue(document.BssType is BssType.Infrastructure, "Failed to get wireless profile BSS type.");
		Assert.IsTrue(document.Authentication is AuthenticationMethod.WPA_Personal, "Failed to get wireless profile authentication.");
		Assert.IsTrue(document.Encryption is EncryptionType.TKIP, "Failed to get wireless profile encryption.");
	...
	public void LoadProfileTest2()
	{
		...
		Assert.IsTrue(document.BssType is BssType.Infrastructure, "Failed to get wireless profile BSS type.");
		Assert.IsTrue(document.Authentication is AuthenticationMethod.WPA2_Personal, "Failed to get wireless profile authentication.");
		Assert.IsTrue(document.Encryption is EncryptionType.AES, "Failed to get wireless profile encryption.");
		Assert.IsTrue(document.IsAutoConnectEnabled, "Failed to get wireless profile automatic connection.");
		Assert.IsTrue(document.IsAutoSwitchEnabled, "Failed to get wireless profile automatic switch.");
	...
	public void LoadProfileTest3()
	{
		...
		Assert.IsTrue(document.BssType is BssType.Independent, "Failed to get wireless profile BSS type.");
		Assert.IsTrue(document.Authentication is AuthenticationMethod.Open, "Failed to get wireless profile authentication.");
		Assert.IsTrue(document.Encryption is EncryptionType.None, "Failed to get wireless profile encryption.");
		Assert.IsTrue(!document.IsAutoConnectEnabled, "Failed to get wireless profile automatic connection.");
		Assert.IsTrue(!document.IsAutoSwitchEnabled, "Failed to get wireless profile automatic switch.");
