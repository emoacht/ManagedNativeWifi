...
namespace ManagedNativeWifi.Win32
{
	...
	internal class SafeClientHandle : SafeHandle
	{
		...
		{
			var result = WinApi.WlanCloseHandle((HANDLE)handle);
			return ((WIN32_ERROR)result is WIN32_ERROR.ERROR_SUCCESS);
		}

		public static SafeClientHandle CreateFromPointer(HANDLE handle)
		{
			var safeHandle = new SafeClientHandle();
